...
class TestServer(test.TestCase):
    ...
    def load_app(self, project=None, cloudstor_creds=None):
        with mock.patch('vendordata.keystone_client') as mock_keystone:
            # default fake project and creds
            mock_keystone.get_project.return_value = project
    ...
    def test_server_with_creds(self):
        ...
        app = self.load_app(project=project, cloudstor_creds=creds)
    ...
    def test_server_project_not_found(self):
        project = None
        creds = None
